...
import { HeaderTabsAllowed } from '../../constants/header-tabs';
...
export const HeaderTabs = ({ user }: HeaderTabsProps) => {
  ...
  const items = HeaderTabsAllowed.map((tab) => (
    <Tabs.Tab label={tab} key={tab} />
  ));
    ...
    <div className={classes.header}>
      <Container className={classes.mainSection}>
        <Group position='apart'>
          <h3 style={{ color: '#fff', margin: 0 }}>Pok&eacute;One Dashboard</h3>
